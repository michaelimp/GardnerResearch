...
ARRIVAL_RATE = .8 * NUM_SERVERS  # DEFAULT .5
...
select_server_policy_list = ["Fastest idle server", "Query faster servers"] 
SELECT_SERVER_POLICY = select_server_policy_list[0] # Used in pick_server()
